...
// "Directions" that asks which app: Apple Maps or Google Maps. Same
// button styling as before via className; the chooser is a small sheet.
export default function DirectionsButton({ name, lat, lng, className = 'btn btn-ghost btn-sm', style, children }) {
