export const VILLANOVA_LANDMARKS = [
  ...
  },
  {
    ...
    lng: -75.3422,
    categories: ["food-local-life"],
    summary: "A Villanova University residence hall, in The Commons, Villanova's residential complex near Lancaster Avenue. Position is a rough placeholder -- drag the pin on the Map to its exact spot.",
    facts: [
      "One of Villanova's residence halls",
      "Houses undergraduate students",
      "Exact pin location not yet verified -- drag to fix",
